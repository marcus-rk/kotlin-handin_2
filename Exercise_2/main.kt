...
fun main() {
    ...
    val laptop: Laptop = Laptop("428", 5666.0, "White")
    ...
    // Store the instances in a list (Possible because of polymorphism -> all type Computer)
    val devices: List<Computer> = listOf(computer, laptop, smartPhone)

    // Display the list with forEach and lambda expression (Just because)
